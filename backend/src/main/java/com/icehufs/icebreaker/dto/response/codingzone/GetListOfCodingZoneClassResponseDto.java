...
public class GetListOfCodingZoneClassResponseDto extends ResponseDto{
    ...
    private GetListOfCodingZoneClassResponseDto(List<CodingZoneClass> CodingZoneClassListEntities){
    super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    this.classList = CodingZoneClassListItem.getList(CodingZoneClassListEntities);
    }

    public static ResponseEntity<GetListOfCodingZoneClassResponseDto> success(List<CodingZoneClass> CodingZoneClassListEntities){
        GetListOfCodingZoneClassResponseDto result = new GetListOfCodingZoneClassResponseDto(CodingZoneClassListEntities);
